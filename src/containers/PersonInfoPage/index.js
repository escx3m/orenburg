...
const mapStateToProps = ({ trips: { cityFrom, cityTo, seats, date, dateStart, dateEnd, cityFromText, cityToText, dateText, timeText }, passengers, payment: { idempotenceKey, loading, error } }) => ({
  cityFrom,
  cityTo,
  seats,
  date,
